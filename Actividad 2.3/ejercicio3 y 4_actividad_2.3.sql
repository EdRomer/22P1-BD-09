...
#Modifique el procedimiento "sp_guardar_factura" de manera que identifique según el id da factura, si la misma ya existe, de ser asi, 
#entonces que actualice los datos de la factura, de lo contrario que cree un registro nuevo.
